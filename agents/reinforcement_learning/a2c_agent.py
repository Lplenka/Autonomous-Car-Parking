...
from stable_baselines3 import HerReplayBuffer, A2C
...
model_class = A2C  # works also with DQN, DDPG and TD3
N_BITS = 15
...
# You can replace TQC with A2C agent
model = model_class('MultiInputPolicy', env, verbose=1,
            learning_rate=1e-3,
            gamma=0.95, policy_kwargs=dict(net_arch=[512, 512, 512]))
# model.learn(int(5e4))
