...
from highway_env_custom.envs.common.observation import MultiAgentObservation, observation_factory
from highway_env_custom.road.lane import StraightLane, LineType
from highway_env_custom.road.road import Road, RoadNetwork
from highway_env_custom.vehicle.objects import Landmark
...
class ParkingEnv(AbstractEnv, GoalEnv):
    ...
    def _info(self, obs, action) -> dict:
        ...
        if isinstance(self.observation_type, MultiAgentObservation):
            ...
            obs = self.observation_type_parking.observe_original()
    ...
    def _create_vehicles(self) -> None:
        ...
        for i in range(self.config["controlled_vehicles"]):
            ...
            # vehicle = self.action_type.vehicle_class(self.road, [i*20, 0], 6.106214309613199, 0)            
...
register(
    id='parkingcustom-v0',
    entry_point='highway_env_custom.envs:ParkingEnv',
)

register(
    id='parking-ActionRepeat-v0',
    entry_point='highway_env_custom.envs:ParkingEnvActionRepeat'
)
