...
from highway_env_custom.envs.common.abstract import AbstractEnv, MultiAgentWrapper
from highway_env_custom.road.lane import LineType, StraightLane, CircularLane, AbstractLane
from highway_env_custom.road.regulation import RegulatedRoad
from highway_env_custom.road.road import RoadNetwork
from highway_env_custom.vehicle.kinematics import Vehicle
from highway_env_custom.vehicle.controller import ControlledVehicle
...
register(
    id='intersection-v0',
    entry_point='highway_env_custom.envs:IntersectionEnv',
)

register(
    id='intersection-multi-agent-v0',
    entry_point='highway_env_custom.envs:MultiAgentIntersectionEnv',
)

register(
    id='intersection-multi-agent-v1',
    entry_point='highway_env_custom.envs:TupleMultiAgentIntersectionEnv',
)
