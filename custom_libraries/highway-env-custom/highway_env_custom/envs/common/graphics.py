...
from highway_env_custom.envs.common.action import ActionType, DiscreteMetaAction, ContinuousAction
from highway_env_custom.road.graphics import WorldSurface, RoadGraphics
from highway_env_custom.vehicle.graphics import VehicleGraphics

if TYPE_CHECKING:
    from highway_env_custom.envs import AbstractEnv
    from highway_env_custom.envs.common.abstract import Action
...
class ObservationGraphics(object):
    ...
    def display(cls, obs, sim_surface):
        from highway_env_custom.envs.common.observation import LidarObservation
