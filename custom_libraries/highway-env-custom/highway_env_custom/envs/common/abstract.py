...
from highway_env_custom import utils
from highway_env_custom.envs.common.action import action_factory, Action, DiscreteMetaAction, ActionType
from highway_env_custom.envs.common.observation import observation_factory, ObservationType
from highway_env_custom.envs.common.finite_mdp import finite_mdp
from highway_env_custom.envs.common.graphics import EnvViewer
from highway_env_custom.vehicle.behavior import IDMVehicle, LinearVehicle
from highway_env_custom.vehicle.controller import MDPVehicle
from highway_env_custom.vehicle.kinematics import Vehicle
...
class AbstractEnv(gym.Env):
    ...
    def default_config(cls) -> dict:
        ...
        return {
            ...
            "other_vehicles_type": "highway_env_custom.vehicle.behavior.IDMVehicle",
            "screen_width": 600,  # [px]
    ...
    def change_vehicles(self, vehicle_class_path: str) -> 'AbstractEnv':
        ...
        :param vehicle_class_path: The path of the class of behavior for other vehicles
                             Example: "highway_env_custom.vehicle.behavior.IDMVehicle"
