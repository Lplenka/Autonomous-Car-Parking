...
from highway_env_custom.utils import Vector
from highway_env_custom.vehicle.dynamics import BicycleVehicle
...
class ActionType(object):
    ...
    def vehicle_class(self) -> Callable:
        ...
        Must return a subclass of :py:class:`highway_env_custom.vehicle.kinematics.Vehicle`.
        """
        raise NotImplementedError
    ...
    def act(self, action: Action) -> None:
        ...
        vehicle is an instance of the specified :py:class:`highway_env_custom.envs.common.action.ActionType.vehicle_class`.
