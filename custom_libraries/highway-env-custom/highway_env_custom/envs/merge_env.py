...
from highway_env_custom.road.lane import LineType, StraightLane, SineLane
...
from highway_env_custom.vehicle.objects import Obstacle
...
register(
    id='merge-v0',
    entry_point='highway_env_custom.envs:MergeEnv',
)
